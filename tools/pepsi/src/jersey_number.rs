...
pub async fn jersey_number(arguments: Arguments, repository: &Repository) -> Result<()> {
    ...
    // Check if two NaoNumbers are assigned to the same JerseyNumber
    // or if a NaoNumber is assigned to multiple JerseyNumbers
    ...
    ProgressIndicator::map_tasks(
        ...
        |assignment, _progress_bar| {
            ...
            async move {
                repository
                    .set_jersey_number(head_id, assignment.jersey_number)
                    .await
