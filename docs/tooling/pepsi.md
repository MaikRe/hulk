...
`pregame` combines deactivating communication (to avoid sending illegal messages), assigning jerseynumbers, setting a wifi network, uploading, and restarting the HULK service.
